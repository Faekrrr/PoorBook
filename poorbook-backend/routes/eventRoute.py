...
@eventRouter.post("/events", status_code=status.HTTP_201_CREATED, response_model= ApiResponse, tags=["Events"])
...
@eventRouter.post("/events", status_code=status.HTTP_200_OK, response_model= ApiResponse, tags=["Events"])
